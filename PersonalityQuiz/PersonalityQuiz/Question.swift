    ...
    var definition: String {
        ...
        case .dog:
            return """
                ...
                You surround yourself with the people you love and enjoy
                activities with your friends.
                """
        case .cat:
            return """
                Mischievous, yet mild-tempered,
                you enjoy doing things on your own terms.
                """
        case .rabbit:
            return """
                You love everything that's soft.
